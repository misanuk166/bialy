        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 px-3 py-2 rounded-md text-sm font-medium transition-colors ${config.mode === 'smoothing'
            ...
            <button
              ...
              className={`flex-1 px-3 py-2 rounded-md text-sm font-medium transition-colors ${config.mode === 'groupBy'
                  ? 'bg-blue-600 text-white'
                  : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                }`}
            >
